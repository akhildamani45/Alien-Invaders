...
class Invaders(GameApp):
    ...
    def start(self):
        ...
        self._text = GLabel(text = "Press 's' to Play", font_name = 'Arcade.ttf',
         font_size = 64, x = GAME_WIDTH/2, y = GAME_WIDTH/2)
        self.lastkeys = 0
    ...
    def update(self,dt):
        ...
        if self._state == STATE_INACTIVE:
            ...
            if self._wave.getvictory():
                self._text = GLabel(text = "YOU WIN", font_name = 'Arcade.ttf',
                font_size = 64, x = GAME_WIDTH/2, y = GAME_WIDTH/2)
    ...
    def shipgone(self):
        """
        Either continues game or ends it when ship is destroyed
        """
